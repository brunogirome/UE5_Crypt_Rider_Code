...
ACryptRaiderCharacter::ACryptRaiderCharacter()
{
	...
	GrabberComponent->SetupAttachment(FirstPersonCameraComponent);
}
...
void ACryptRaiderCharacter::SetupPlayerInputComponent(UInputComponent *PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent *EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(GrabAction, ETriggerEvent::Canceled, this, &ACryptRaiderCharacter::Release);
	}
	else
	{
...
void ACryptRaiderCharacter::Grab()
{
	if (GrabberComponent)
	{
...
void ACryptRaiderCharacter::Release()
{
	if (GrabberComponent)
	{
